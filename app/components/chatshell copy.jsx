    ...
    <div className="flex flex-col h-[700px] w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl bg-white rounded-3xl shadow-xl overflow-hidden border border-blue-100">
      ...
      {/* Example GPT Message */}
        <div className="flex items-start gap-3">
          <div className="max-w-xs p-3 ml-3 rounded-2xl bg-green-200 text-gray-900">
            Hello! To get started you could provide me with your annual income, state you live in, and any dependents you have.
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 pb-28 space-y-4 bg-white border-b border-gray-300 relative">
        ...
        <div className="flex justify-end">
          <div className="max-w-xs p-3 rounded-2xl bg-blue-400 text-white">
      ...
      <div className="bg-gray-50">
        <div className="grid grid-cols-4 gap-2 p-3">
          ...
          <button
            className="py-3 px-2 bg-red-200 shadow rounded-xl text-xs sm:text-sm text-center font-medium border border-gray-200 active:scale-95"
